...
st.title("Cyber Risk Detection System")
st.markdown("""
...
**8. Prediction** — Run predictions on new data
""")

if not csv_files:
    st.warning("No dataset found. Please go to the Dataset page for download instructions.")
